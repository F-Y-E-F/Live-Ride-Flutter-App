  ...
  static Future<Database> initDB() async {
    ...
    return await openDatabase(join(dbPath, 'trips.db'),
        ...
        onCreate: (database, version) => database.execute(
            "CREATE TABLE trips(id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name TEXT, color TEXT,averageSpeed REAL, distance REAL, maxSpeed REAL, altitude REAL,duration INTEGER, calories INTEGER, startTime TEXT, endTime TEXT, coordinatesList TEXT, intervalSpeeds TEXT)"));
  }
